...
% Frontespizio
%**************************************************************
\newcommand{\myName}{Davide Polonio, Giacomo Manzoli}           % autore
\newcommand{\myTitle}{Mobile Programming}
...
{
	% list of keywords
	morekeywords={application, uses-permission, uses, permission, xml, version, encoding, service, activity, intent -filter, manifest},
...
{
	morekeywords={ListView, ArrayAdapter, Context, R, String, WifiManager}
}
